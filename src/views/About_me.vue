        ...
        >
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <div
                    ...
                    style="background-image: url('/src/assets/profile.JPG')"
                ></div>

                <h1 class="text-3xl font-bold pt-8 lg:pt-0">Kunsarifan</h1>
                <div
                ...
                >
                    ...
                    Jl. Patimura No.42 RT 03/04 Buntu Kec. Kroya Kab.Cilacap
                </p>
                <p class="pt-8 text-sm">
                    "Jika Kita mempunyai rencana yang lebih indah , Wujudkanlah
                    buatlah impianmu menjadi kebanggaan bagi dirimu sendiri &
                    Orang Tua"
                </p>
